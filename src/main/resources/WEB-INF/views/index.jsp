...
<div id="container">
    ...
    <div class="question-container">
        ...
        <div class="qa-block"> <span class="question">Additional details about this game & Varen's viewpoint on the referral process:</span>
            <div class="answer"><p>
                <b>The new referral philosophy at Varen Technologies - </b><b style="color: red;">Leads</b>. <br>In an effort to make our employee referral program an easier one in which to participate, we have decided to break the mold for traditional concept of an employee referral. In short, we want to expand our thinking of referrals to include<i> referral </i><i style="color:red;">leads</i>. In doing so, we should experience a threefold effect; 1.) the employee referral pool should increase 2.) the potential degree of effort involved for our employees should decrease, & 3.) there should be an increase in comfort level for those who wish to participate.  Here are some of the concepts that are part of this expanded way of viewing employee referrals: <br>
                ...
                <br><br><b>Here is how it works:</b><br>1. Forward to recruiting the name of an individual that you know, or know of, along with contact information or information about that person that could help us locate contact information (ie - current and/or former employers or technical group associations).
...
<h4>Participation and referral progress are tracked, and activity levels are assigned rewards points to referrer as follows:</h4>
    <div class="paragraph" style="text-align: left">
        <p><b>1 point**</b> for any referral made <br><b>2 points**</b> for any referral which procures an in-person interview<br>
            <b>2 points**</b> for any referral which receives an offer, contingent or firm <br><b>4 points**</b> for any referral who accepts an offer and starts (awarded on start date)<br>
           <br><b>**</b> = Points double if candidate is cleared and has the technical skill set.<br>
          <br><br><b>Rewards:</b>
            <br><br><strong>Prize Levels - Collect fabulous prizes as you accumulate points (refer to prize tab for more information)</strong><br><br><strong>LEVEL 1:</strong> 8 points | <strong>LEVEL 2:</strong> 18 points | <strong>LEVEL 3:</strong>
            26 points | <strong>LEVEL 4:</strong> 36 points | <strong>LEVEL 5:</strong> 44 points | <strong>LEVEL 6:</strong> 54 points</p>
            <b>Monthly participation drawings:</b> - Each month, Varen will have a drawing ($500 cash/Amazon card) for all employees who have accumulated rewards points within the given month. Rewards points earned within the month will be tallied and the winner will be announced from a random rewards drawing. Each point reward earning within the month will correlate to the number of chances / tickets placed into the monthly drawing.<br><br>
            <b>Employee Referrer of the Year:</b> - Employee with the most points accumulated over the duration of the rewards promotion earns a 10K bonus.<br>
...
<script>
    document.querySelectorAll('.question-container svg').forEach(function(element){
