...
<div id="recruitertables">
    ...
    <table id="table" class="display tablestyle tr" style="width: 100%;">
        ...
        <sec:authorize access="hasAnyAuthority('admin', 'superadmin')">
            <button class="standard-button orange" @click="deleted_referrals" v-if="referral_view == 'default'">View Deleted Referrals</button>
            <button class="standard-button green" @click="referrals" v-if="referral_view == 'deleted'">Back to Referrals</button>
        </sec:authorize>
