$(document).ready(function () {
  ...
  $('div.overlay').each(function () {
    $(this).click(function () {
      if (this.closest('.overlaycontainer').classList.contains(
          'inactive')) {
        return;
      }
      ...
      $('.details button').each(function () {
        if ($(this).attr('id') == "noclick") {
          $(this).unbind().bind('click', function () {
            alert(
                "Sorry, you do not have enough points to redeem from this prize level!");
          });
        }
      ...
      $('#managerinfo input[type="submit"]').unbind().bind('click',
          (function (event) {
            ...
            var prizeData = {
              ...
              "prizeName": document.querySelector('#popup').querySelector(
                  '.details h1').innerHTML
            };
            var data = $('#managerinfo').serializeArray().reduce(
                function (a, x) {
                  a[x.name] = x.value;
                  return a;
                }, {});
            ...
            .done(function () {
              alert(
                  'Thank you! Your prize was redeemed. You will be notified by HR when your prize is available for pickup at Varen HQ.');
            ...
            .fail(function () {
              alert(
                  'Oops! An error occurred and your prize could not be redeemed.');
            })
          })
      );
      //send data when delivery form is submitted
      $('#homedeliveryinfo input[type="submit"]').unbind().bind('click',
          (function (event) {
            event.preventDefault();
            var prizeLevel = vm.popup_level;
            var prizedata = {
            ...
            var data = $('#homedeliveryinfo').serializeArray().reduce(
                function (a, x) {
                  a[x.name] = x.value;
                  return a;
                }, {});
            ...
            .done(function () {
              ...
              $('#deliverypopup').hide();
              alert(
                  'Thank you! Your prize was redeemed. You will be notified by HR when your prize has been shipped.');
            })
            .fail(function () {
              alert(
                  'Oops! An error occurred and your prize could not be redeemed.');
  ...
  $('#lev1prize1').click(function () {
    ...
    $('#largerimg').css(
        {'width': '80%', 'margin-left': '10%', 'height': 'auto'});
    $('.details h1').html('Netgear Universal Wi-Fi<br>Range Extender');
    $('.details p').html(
        'Broaden your network connection with a range extender that gives you '
        +
  ...
  $('#lev1prize3').click(function () {
    ...
    $('.details p').html(
        "Marty Leshin is the President/CEO of Varen Technologies. Have the opportunity to talk "
        +
        "one-on-one with him during lunch at the restaurant of your choosing.");
  });
  //Amazon Fire TV Stick
  $('#lev1prize4').click(function () {
    $('#popup #largerimg').attr('src', '../images/lev1prize4.jpg');
    $('#largerimg').css(
        {'width': '80%', 'margin-left': '10%', 'height': 'auto'});
    $('.details h1').html('Amazon Fire Stick');
    $('.details p').html(
        'The most powerful 4K streaming media stick with a Wi-Fi antenna design optimized for 4K Ultra HD streaming.' +
    'Launch and control content with the Alexa Voice Remote. Watch favorites from Netflix, Prime Video, Hulu, STARZ, SHOWTIME, or CBS All Access, plus stream for free with Pluto TV, IMDb Freedive, and others.');
  });
  ...
  $('#lev2prize1').click(function () {
    ...
    $('#largerimg').css(
        {'width': '80%', 'margin-left': '10%', 'height': 'auto'});
    $('.details p').html(
        'Fitbit Charge 2 Heart Rate + Fitness Wristband: Put your daily exercise motivation on your'
        +
  ...
  $('#lev2prize2').click(function () {
    ...
    $('.details p').html(
        'Produce physical copies of smartphone image files with this Bluetooth-enabled HP Sprocket '
        +
  ...
  $('#lev2prize3').click(function () {
    ...
    $('.details p').html(
        "Enjoy big audio from a compact system with the Sonos PLAY:1. This speaker's custom-tuned "
        +
  ...
  $('#lev2prize4').click(function () {
    ...
    $('.details p').html(
        "The newest Keurig® single serve coffee maker, the K-Elite™ coffee maker features Strong "
        +
  ...
  $('#lev3prize1').click(function () {
    ...
    $('.details p').html(
        'Document an adventure from different angles with this Protocol Dronium drone. Its camera '
        +
  ...
  $('#lev3prize2').click(function () {
    ...
    $('.details p').html(
        'If it is a day trip or an extended stay the YETI® Roadie 20 is made to last no matter how '
        +
  ...
  $('#lev3prize3').click(function () {
    ...
    $('#largerimg').css({'width': '100%', 'height': 'auto'});
    $('.details h1').html(
        'PlayStation VR The Elder Scrolls<br>V: Skyrim VR Bundle');
    $('.details p').html(
        'Surround yourself with the sights and sounds of a favorite gaming franchise with this '
        +
  ...
  $('#lev3prize4').click(function () {
    ...
    $('.details p').html(
        "Fill your home with rich, dynamic sound with Sonos Play:3, a speaker that's versatile "
        +
  ...
  $('#lev4prize1').click(function () {
    ...
    $('.details p').html(
        "Beats Studio3 Wireless headphones deliver a premium listening experience with Pure Adaptive "
        +
  ...
  $('#lev4prize2').click(function () {
    ...
    $('.details p').html(
        "The Vitamix Explorian Series Blender boasts high-performance with powerful variable speed "
        +
  ...
  $('#lev4prize3').click(function () {
    ...
    $('.details p').html(
        "Show off your personality when playing favorite Switch video games with this neon Nintendo "
        +
  ...
  $('#lev4prize4').click(function () {
    ...
    $('.details p').html(
        "This Insignia™ NS-BK1TSS6 kegerator/beverage cooler holds either a 1/2 keg or a 1/4 slim keg "
        +
  ...
  $('#lev5prize1').click(function () {
    ...
    $('.details p').html(
        "With an update on an old favorite, the Pelican® Trailblazer NXT Kayak boasts plenty of new features! "
        +
  ...
  $('#lev5prize2').click(function () {
    ...
    $('.details p').html(
        "This attractively styled KitchenAid Artisan Stand Mixer is reason enough for you to get "
        +
  ...
  $('#lev5prize3').click(function () {
    ...
    $('.details p').html(
        "Conquer virtual enemies with this Sony PlayStation 4. It's compatible with the latest game "
        +
  ...
  $('#lev5prize4').click(function () {
    ...
    $('.details p').html(
        "Includes:<br>Sony 32gb microSDHC Memory Card<br>Memory Card Wallet<br>Microfiber Cleaning Cloth<br>"
        +
  ...
  $('#lev6prize1').click(function () {
    ...
    $('.details p').html(
        "Answer a call from your surfboard. Ask Siri to send a message. Stream your favorite songs on "
        +
  ...
  $('#lev6prize2').click(function () {
    ...
    $('.details p').html(
        "Enjoy UHD movies and improve your gaming experience with this Sony 4K smart television, which "
        +
  ...
  $('#lev6prize3').click(function () {
    ...
    $('.details p').html(
        "Comprising a versatile set of imaging capabilities along with support for a connected "
        +
  ...
  $('#lev6prize4').click(function () {
    ...
    $('.details p').html(
        "**or comparable bike from BikesDirect.com – call HR for details**<br>Handbuilt advanced engineered and lightweight Altair 1 aluminum compact frame. Shimano 105/4600 "
        +
