...
<div id="container">
    ...
    <p class="descriptions">Please enter as much information as you can. You can submit either a lead (with no resume) or a referral (with a resume).
        If you are submitting a lead, you only need to provide a full name, but the more information you can give, the better. If you are submitting a referral, you must include at least the candidate's
        ...
        Recruiting Department throughout the recruiting process, but please reach out with questions using the 'Send a Question' button at the top of the page!</p>


<div class="form" id="vue" v-cloak>
           <form action="refer"  id="referral_form" method="post" v-show="form_mode == 'submit'" modelAttribute="refform" enctype="multipart/form-data" @submit="register">
            <fieldset>
               <legend><strong>Candidate Information</strong></legend>
                <span class="required">*</span>Is this a lead or referral?
                ...
                <label for="type2">Referral</label><br>
                   <br>
                <div class="underline-input"><span class="required">*</span><label for="lastName">Last Name:</label><br>
                ...
                <span class="required">*</span><label for="firstName">First Name:</label><br>
                ...
                <br><div class="underline-input">
                <span class="required">*</span><label for="candidateEmail">Email:</label><br>
                ...
                <br><div class="underline-input">
                <span class="required">*</span><label for="candidatePhone">Phone Number:</label><br>
                ...
                <br>
                <div>
                    <span class="required">*</span><label>Clearance Level:</label><br>

                <input type="radio" name="clearanceLevel" id="cleared" value="1" required>
                <label for="cleared">TS/SCI with Polygraph</label> &nbsp;
                <input type="radio" name="clearanceLevel" id="notcleared" value="0" required>

                <label for="notcleared">Other / No clearance</label><br>
                    <br></div>
                <br><div class="underline-input">
                <span class="required">*</span><label for="possiblePosition">Position Referred For:</label><br>
            ...
            <fieldset>
                ...
                <div class="underline-input">
                    <span class="required">*</span><label for="empln">Last Name:</label><br>
                ...
                <br><div class="underline-input">
                <span class="required">*</span><label for="empfn">First Name:</label><br>
                ...
                <br><div class="underline-input">
                <span class="required">*</span><label for="empemail">Employee Email:</label><br>
                ...
                <br>
                <span class="required">*</span>Do you wish to remain anonymous during the recruitment process?<br>
...
<script>
    ...
    function alertMsg() {
        alert("Thank you! Your submission was received and you will be awarded the appropriate points.");
    }
        ...
        methods: {
            ...
            empln_change: function (event) {
                ...
                if (!alphanumericRegex.test(event.target.value)) {
                    ...
                    this.empln_error_msg = "Last name must be alphabetical";
                    return;
                }
            ...
            empfn_change: function (event) {
                ...
                if (!alphanumericRegex.test(event.target.value)) {
                    ...
                    this.empfn_error_msg = "First name must be alphabetical";
                    return;
                }
            ...
            register:function(e){
                ...
                console.log(document.querySelector('#type1').value);
                if(this.has_firstName_error || this.has_lastName_error || this.has_candidateEmail_error || this.has_candidatePhone_error || this.has_clearanceLevel_error || this.has_possiblePosition_error|| this.has_knownBy_error||this.has_qualifications_error||this.has_resume_error||this.has_empfn_error||this.has_empln_error||this.has_empemail_error){
                    e.preventDefault();
                    alert("Form cannot be submitted. Please look for any error messages on entered fields.")
                }
                else{
                    alert("Thank you! Your submission was received and you will be awarded the appropriate points.");
                }
