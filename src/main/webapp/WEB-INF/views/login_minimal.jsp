...
<div id="vue">
    ...
    <form id="login-form" action="login" method="post" v-show="form_mode == 'login'">
        <p id="login-instructions">
            Welcome to the "Lead the Way" Referral Portal and new promotion for 2018! To enter the site, simply sign in using your Varen email/password combination. Upon logging onto the site, promotional and referral instructions await you in addition to other features such as a referral leader board, prize page and status page for your referrals!
        </p>
        <div class="underline-input">
            <input id="login-username" type="text" name="username" required>
            <label for="login-username">Varen Email</label>
            <span class="error"></span></div>
        <div class="underline-input">
            <input id="login-password" type="password" name="password" required>
            <label for="login-password">Varen Password</label>
            <span class="error"></span></div>
